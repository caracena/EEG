...
After setting up a base line based on previous work, we explored the use of a new paradigm based on Representation Learning: the use of Convolutional Neural Networks (CNN) for  EEG-based emotion recognition.  To the best of our knowledge, this is first time this methodology is used for this purpose.

After a empirical studty, our main findings are....
